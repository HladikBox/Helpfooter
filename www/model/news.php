...
public function list($param){ /**************
     ...
     ****************/
     $request=$param;
     $request["status"]="A";
     $request["orderby"]="r_main.published_date desc";
     ...
     for($i=0;$i<count($result);$i++){
         $result[$i]["published_date_m"]=date("M",strtotime($result[$i]["published_date"]));
         $result[$i]["published_date_d"]=date("d",strtotime($result[$i]["published_date"]));
     }
